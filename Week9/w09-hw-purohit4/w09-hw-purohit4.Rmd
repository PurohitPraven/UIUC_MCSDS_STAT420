...
Looking at the above plots and the results of the Shapiro tests and BP test, we conclude that the Normal distribution of errors and constant variance assumptions of the model are not violated. The model is fitting using a linear expression hence the linearity assumption is also not violated.
