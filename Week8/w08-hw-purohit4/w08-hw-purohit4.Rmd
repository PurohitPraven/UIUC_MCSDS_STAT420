...
ggplot(data = m1, aes(y=loss, x=Fe)) + geom_point() +stat_smooth(method = lm, se = FALSE) + ggtitle("Scatter plot to show relationship between loss and Iron content from corrosion dataset")
