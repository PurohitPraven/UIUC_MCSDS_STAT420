...
```
```{r}
sim_data <- function(sample_size, mu, sig, beta_0, beta_1, beta_2, beta_3, num_simul, x_predictors_df){
...
sig <- 1
Significant_sigma_1_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)


sig <- 5
Significant_sigma_5_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)


sig <- 10
Significant_sigma_10_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)
```
...
```{r} 
sig <- 1
Nonsignificant_sigma_1_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)


sig <- 5
Nonsignificant_sigma_5_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)

sig <- 10
Nonsignificant_sigma_10_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)
...
```{r fig.width=15}
s_s1 <- 
  ggplot(data = Significant_sigma_1_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Significant model-sigma 1") +
    theme_linedraw() 

s_s5 <- 
  ggplot(data = Significant_sigma_5_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Significant model-sigma 5") +
    theme_linedraw() 


s_s10 <- 
  ggplot(data = Significant_sigma_10_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Significant model-sigma 10") +
    theme_linedraw() 


ns_s1 <- 
  ggplot(data = Nonsignificant_sigma_1_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Non Significant model-sigma 1") +
    theme_linedraw()

ns_s5 <- 
  ggplot(data = Nonsignificant_sigma_5_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Non Significant model-sigma 5") +
    theme_linedraw()

ns_s10 <- 
  ggplot(data = Nonsignificant_sigma_10_df, aes(x=f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("fstat-Non Significant model-sigma 10") +
    theme_linedraw()

grid.arrange(s_s1, s_s5, s_s10, ns_s1, ns_s5, ns_s10, ncol=3, nrow=2)
...
```{r fig.width=15}
s_s1 <- 
  ggplot(data = Significant_sigma_1_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Significant model-sigma 1") +
    theme_linedraw() 


s_s5 <- 
  ggplot(data = Significant_sigma_5_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Significant model-sigma 5") +
    theme_linedraw()


s_s10 <- 
  ggplot(data = Significant_sigma_10_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Significant model-sigma 10") +
    theme_linedraw() 

ns_s1 <- 
  ggplot(data = Nonsignificant_sigma_1_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Non Significant model-sigma 1") +
    theme_linedraw() 

ns_s5 <- 
  ggplot(data = Nonsignificant_sigma_5_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Non Significant model-sigma 5") +
    theme_linedraw()

ns_s10 <- 
  ggplot(data = Nonsignificant_sigma_10_df, aes(x=pval)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("pval-Non Significant model-sigma 10") +
    theme_linedraw()
...
```{r fig.width=15}
s_s1 <- 
  ggplot(data = Significant_sigma_1_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Significant model-sigma 1") +
    theme_linedraw() 


s_s5 <- 
  ggplot(data = Significant_sigma_5_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Significant model-sigma 5") +
    theme_linedraw()


s_s10 <- 
  ggplot(data = Significant_sigma_10_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Significant model-sigma 10") +
    theme_linedraw() 

ns_s1 <- 
  ggplot(data = Nonsignificant_sigma_1_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Non Significant model-sigma 1") +
    theme_linedraw() 

ns_s5 <- 
  ggplot(data = Nonsignificant_sigma_5_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Non Significant model-sigma 5") +
    theme_linedraw()

ns_s10 <- 
  ggplot(data = Nonsignificant_sigma_10_df, aes(x=r2)) + 
    geom_histogram(aes(y=stat(density),color=I("orange"))) +
    ggtitle("R2-Non Significant model-sigma 10") +
    theme_linedraw()
...
For R2 say things about skewness and symetry. Distribution of p value for one of the 2 models will look fimiliar
