...
sig <- 1
Sigificant_sigma1_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)

sig <- 5
Sigificant_sigma5_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)

sig <- 10
Sigificant_sigma10_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)
...
sig <- 1
Nonsigificant_sigma1_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)

sig <- 5
Nonsigificant_sigma5_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)

sig <- 10
Nonsigificant_sigma10_df <- sim_data(sample_size = n, mu = mu, sig = sig, beta_0 = beta_0, beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, num_simul = num_simul, x_predictors_df = x_predictors_df)


all_df <- cbind(Sig_sigma_1 = Sigificant_sigma1_df, 
                Sig_sigma_5 = Sigificant_sigma5_df, 
                Sig_sigma_10 = Sigificant_sigma10_df,
                Nonsig_sigma_1 = Nonsigificant_sigma1_df,
                Nonsig_sigma_5 = Nonsigificant_sigma5_df, 
                Nonsig_sigma_10 = Nonsigificant_sigma10_df)
...
s_s1 <- ggplot(data = all_df, aes(x=Sig_sigma_1.f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
  ggtitle("fstat-Significant model-sigma 1") +
  theme_linedraw()

s_s5 <- ggplot(data = all_df, aes(x=Sig_sigma_5.f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
  ggtitle("fstat-Significant model- sigma 5") +
  theme_linedraw()

s_s10 <- ggplot(data = all_df, aes(x=Sig_sigma_10.f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
  ggtitle("fstat-Significant model- sigma 10") +
  theme_linedraw()

ns_s1 <- ggplot(data = all_df, aes(x=Nonsig_sigma_1.f_stat)) +
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
  ggtitle("fstat-Non-Significant model- sigma 1") +
  theme_linedraw()

ns_s5 <- ggplot(data = all_df, aes(x=Nonsig_sigma_5.f_stat)) + 
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
  ggtitle("fstat-Non-Significant model- sigma 5") +
  theme_linedraw()

ns_s10 <- ggplot(data = all_df, aes(x=Nonsig_sigma_10.f_stat)) +
    geom_histogram(aes(y=stat(density),color=I("orange")), binwidth = .2) +
