...
We see that our diagnostic statistics are about the same. 



#### Model selection

Hence we will select the smaller model, m_transform_1_step_sig_only, as our better model
...
We then investigated the result of removing influential observations. As we can see in \@ref(id8)
